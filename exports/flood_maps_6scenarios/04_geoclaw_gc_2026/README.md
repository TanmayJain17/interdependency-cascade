# GeoClaw storm-surge, 2026 horizon (PROVISIONAL) — export for Jesse (pandapower cascade)
...
>
> - depths are inflated (this scenario reaches **3.72 m**; DEP caps at 0.80 m),
> - far too many nodes read as flooded (**373** citywide / **25** power
...
## Scenario
- **Family:** GeoClaw
- **Plain label:** GeoClaw surge 2026
- **Full label:** GeoClaw storm-surge, 2026 horizon (PROVISIONAL)
- **Source column:** `gc_2026_depth_m` (depth in **meters**)
- **Source dataset:** GeoClaw storm-surge model, 2026 horizon, depth sampled from raster (PROVISIONAL — see warning).
...
- Total nodes: **6231**
- Nodes flooded citywide (depth > 0): **373**
- Power nodes: **203**
- Power nodes flooded (depth > 0): **25**
- Max depth: **3.72 m**

## Files
- `geoclaw_gc_2026_nodes.geojson` — all 6231 infrastructure nodes
