# Mid-Century (DEP Moderate, 2050s) — export for Jesse (pandapower cascade)
...
- **Source dataset:** NYC DEP Stormwater Flood Maps — pluvial/tidal compound, Moderate scenario, 2050s horizon.
