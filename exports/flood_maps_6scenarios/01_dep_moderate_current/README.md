# Present-day (DEP Moderate, current) — export for Jesse (pandapower cascade)

## Scenario
- **Family:** DEP
- **Plain label:** Present-day
- **Full label:** Present-day (DEP Moderate, current)
- **Source column:** `flood_moderate_current_depth_m` (depth in **meters**)
- **Source dataset:** NYC DEP Stormwater Flood Maps — pluvial/tidal compound, Moderate scenario, present-day horizon.
...
- Total nodes: **6231**
- Nodes flooded citywide (depth > 0): **61**
- Power nodes: **203**
- Power nodes flooded (depth > 0): **0**
- Max depth: **0.60 m**

## Files
- `dep_moderate_current_nodes.geojson` — all 6231 infrastructure nodes
