# GeoClaw storm-surge, 2080 horizon (PROVISIONAL) — export for Jesse (pandapower cascade)
...
>
> - depths are inflated (this scenario reaches **6.31 m**; DEP caps at 0.80 m),
> - far too many nodes read as flooded (**640** citywide / **32** power
...
## Scenario
- **Family:** GeoClaw
- **Plain label:** GeoClaw surge 2080
- **Full label:** GeoClaw storm-surge, 2080 horizon (PROVISIONAL)
- **Source column:** `gc_2080_depth_m` (depth in **meters**)
- **Source dataset:** GeoClaw storm-surge model, 2080 horizon, depth sampled from raster (PROVISIONAL — see warning).
...
- Total nodes: **6231**
- Nodes flooded citywide (depth > 0): **640**
- Power nodes: **203**
- Power nodes flooded (depth > 0): **32**
- Max depth: **6.31 m**

## Files
- `geoclaw_gc_2080_nodes.geojson` — all 6231 infrastructure nodes
